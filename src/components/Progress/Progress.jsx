    ...
    return (
        <div className="progress">
            <div className="progressBar">
                ...
                <div className={`step ${step >= persons.length + 2 ? "active" : ""}`} onClick={() => setStep(persons.length + 2)}>
                    <span>3</span>
                </div>
                ...
                <div className={`step ${step >= persons.length + 3 ? "active" : ""}` } onClick={() => setStep(persons.length + 3)}>
                    <span>4</span>
                </div>
            </div>
        </div>
